			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
					...
					<!-- <div class="flex-sb-m flex-w p-b-35">
						<label>Tampilkan Kandang berdasarkan Kecamatan : </label>
						<div class="flex-w">
							<div class="rs2-select2 bo4 of-hidden w-size12">
								...
								<div class="block2-img wrap-pic-w of-hidden pos-relative">
									...
									<div class="block2-overlay trans-0-4">
										<div class="block2-btn-addcart w-size1 trans-0-4">
											<a href="<?php echo base_url('Home/product_detail/'.$row['kd_kandang'])?>" style="color: white;"><button class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4">
												LIHAT DATA
											</button></a>
										</div>
									</div>
